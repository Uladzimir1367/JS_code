...
const positivNumber = +prompt('Введите положительное число =  ');
const negativNumber = +prompt('Введите отрицательное число =  ');
if (Number.isNaN(positivNumber || negativNumber)) {
   alert("Нужно писать число!");
} if (positivNumber > 0 && negativNumber < 0) {
   alert("Вы ввели правильные числа");
} else  {
